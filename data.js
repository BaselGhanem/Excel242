...
const FileVaultMap = new Map([
  ['F1', { name: 'Taps Part 1', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '1.2 MB', difficultyLevel: 'Beginner', tags: ['interface', 'basics', 'ribbon'] }],
  ['F2', { name: 'Taps Part 2', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '1.5 MB', difficultyLevel: 'Beginner', tags: ['formulas', 'sum', 'average'] }],
  ['F3', { name: 'كل معادلات الاكسل شرح بالعربي', url: 'https://1drv.ms/...', type: 'PDF Document', category: 'PDF', fileSize: '5.4 MB', difficultyLevel: 'Beginner', tags: ['formulas', 'guide', 'arabic'] }],
  ['F4', { name: 'Editing Multiple Sheets', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '800 KB', difficultyLevel: 'Intermediate', tags: ['sheets', 'editing', 'shortcuts'] }],
  ['F5', { name: 'جميع اختصارات الاكسل', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '1.1 MB', difficultyLevel: 'Beginner', tags: ['shortcuts', 'productivity'] }],
  ['F6', { name: 'Charts & Data Visualization', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '3.2 MB', difficultyLevel: 'Intermediate', tags: ['charts', 'visualization'] }],
  ['F7', { name: 'Copy & Paste Special', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '900 KB', difficultyLevel: 'Beginner', tags: ['paste special', 'formatting'] }],
  ['F8', { name: 'Assignment 2 (الواجب الأول)', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Assignments', fileSize: '500 KB', difficultyLevel: 'Intermediate', tags: ['assignment', 'practice'] }],
  ['F9', { name: '08-Dynamic Design Conditional', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '2.1 MB', difficultyLevel: 'Intermediate', tags: ['conditional formatting', 'design'] }],
  ['F10', { name: '10-Subtotal & SumProduct', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '1.8 MB', difficultyLevel: 'Advanced', tags: ['subtotal', 'sumproduct'] }],
  ['F11', { name: '11-Conditional Formatting Extras', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '1.3 MB', difficultyLevel: 'Intermediate', tags: ['conditional formatting'] }],
  ['F12', { name: '12-On-Mastering Counts & More', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '1.6 MB', difficultyLevel: 'Advanced', tags: ['count', 'statistics'] }],
  ['F13', { name: 'Session Exercise', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Assignments', fileSize: '700 KB', difficultyLevel: 'Intermediate', tags: ['exercise', 'practice'] }],
  ['F14', { name: 'Name Manager', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '1.0 MB', difficultyLevel: 'Intermediate', tags: ['name manager', 'formulas'] }],
  ['F15', { name: 'Data Validation', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '1.4 MB', difficultyLevel: 'Intermediate', tags: ['data validation', 'rules'] }],
  ['F16', { name: 'Data Lookup Symphony (VLOOKUP)', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '2.5 MB', difficultyLevel: 'Advanced', tags: ['vlookup', 'search'] }],
  ['F17', { name: 'Print Perfection (الطباعة الاحترافية)', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '1.9 MB', difficultyLevel: 'Beginner', tags: ['printing', 'layout'] }],
  ['F18', { name: 'Excel Navigation (التنقل الذكي)', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '1.2 MB', difficultyLevel: 'Intermediate', tags: ['navigation', 'go to special'] }],
  ['F19', { name: 'Data Lookup Symphony (VLOOKUP المتقدم)', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '3.0 MB', difficultyLevel: 'Advanced', tags: ['vlookup', 'advanced search'] }],
  ['F20', { name: 'Assignment 3 (الواجب الثالث)', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Assignments', fileSize: '600 KB', difficultyLevel: 'Advanced', tags: ['assignment', 'practice'] }],
  ['F21', { name: 'Using Filter (رحلة المصفوفات)', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '2.8 MB', difficultyLevel: 'Advanced', tags: ['dynamic arrays', 'filter'] }],
  ['F22', { name: 'XLOOKUP (الملك المتوج)', url: 'https://1drv.ms/...', type: 'Excel Workbook', category: 'Excel', fileSize: '2.2 MB', difficultyLevel: 'Advanced', tags: ['xlookup', 'modern arrays'] }],
